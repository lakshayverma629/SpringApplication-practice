...
import verma.lakshay.recepiproject.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        if(!eachUnitOfMeasureOptional.isPresent()||!pintUnitOfMeasureOptional.isPresent()||!teaspoonUnitOfMeasureOptional.isPresent()||!teaspoonUnitOfMeasureOptional.isPresent()
                ||!tablespoonUnitOfMeasureOptional.isPresent()||!cupUnitOfMeasureOptional.isPresent()||!dashUnitOfMeasureOptional.isPresent()||
                !ounceUnitOfMeasureOptional.isPresent()||!pinchUnitOfMeasureOptional.isPresent()){
        ...
        UnitOfMeasure tablespoonUOM=teaspoonUnitOfMeasureOptional.get();
